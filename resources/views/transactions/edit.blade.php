                    ...
                    <form method="POST" action="{{ route('transactions.update', $transaction->transaction_id) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="customer_name" class="block mt-1 w-full" type="text"
                                name="customer_name" :value="old('customer_name', $transaction->customer_name)"
                                required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                ...
                                <x-text-input id="total_price" class="block w-full pl-10" type="number"
                                    name="total_price" :value="old('total_price', $transaction->total_price)"
                        ...
                        <div class="mt-4">
                            ...
                            <select id="payment_method" name="payment_method"
                                ...
                                <option value="debit" {{ old('payment_method', $transaction->payment_method) == 'debit' ? 'selected' : '' }}>Debit Card</option>
                                <option value="credit" {{ old('payment_method', $transaction->payment_method) == 'credit' ? 'selected' : '' }}>Credit Card</option>
