                ...
                <div class="mx-auto py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('stocks.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="stock_name" class="block mt-1 w-full" type="text" name="stock_name" :value="old('stock_name')" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="minimum_stock" class="block mt-1 w-full"
                                         type="number"
                                         name="minimum_stock"
